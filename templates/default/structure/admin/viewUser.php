        ...
        <div class="panel-body">
            ...
            if (num_rows($checkUser) > 0) {
                ...
                <form action="" method="POST">
                    ...
                    <div class="panel-body">
                        <label for="password"><?php echo language('others', 'NEW_PASSWORD'); ?></label>
                        <div class="input-group">
                            <input size="35" type="password" class="form-control" name="password" placeholder="<?php echo language('others', 'NEW_PASSWORD'); ?>" aria-describedby="basic-addon1">
                        </div>
                    </div>
