...
<div class="col-md-4 col-md-offset-3 content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <?php echo language('titles', 'TEXT_SMS'); ?>
        </div>
        ...
        <form action="" method="POST">
            <div class="panel-body">
                <div class="input-group">
                    <textarea cols="55" rows="10" class="form-control" name="homeText" style="resize: none;"><?php
					$getText = query("SELECT * FROM sms_text");
					if(isset($_SESSION['preview'])) {
						echo bbcode_brFix($_SESSION['preview']);
					} else {
						echo bbcode_brFix(fetch_assoc($getText)['home']);
					}
					?></textarea>
				</div>
            </div>
