...
function csbans_getadminID($conn, $servername) {
    $getServerID = query($conn, "SELECT csbans_id FROM servers WHERE shortname='$servername'");
...
function csbans_createAdmin($conn, $servername) {
    $checkServer = query($conn, "SELECT csbans_id FROM servers WHERE shortname='$servername'");
